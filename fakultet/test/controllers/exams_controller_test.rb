...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { exam_place: @exam.exam_place, exam_time: @exam.exam_time, subject_id: @exam.subject_id } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { exam_place: @exam.exam_place, exam_time: @exam.exam_time, subject_id: @exam.subject_id } }
