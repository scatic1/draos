...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post job_applications_url, params: { job_application: { CV: @job_application.CV, JBMG: @job_application.JBMG, date_of_birth: @job_application.date_of_birth, email: @job_application.email, gender: @job_application.gender, job_advertisements_id: @job_application.job_advertisements_id, motivation_letter: @job_application.motivation_letter, name: @job_application.name, place_of_birth: @job_application.place_of_birth, surname: @job_application.surname, telephone_number: @job_application.telephone_number } }
    end
